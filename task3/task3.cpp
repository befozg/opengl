...
int main(void) {
  ...
  GLuint blue_programID =
      LoadShaders("SimpleTransform.glsl", "BlueFragmentShader.glsl");

  GLuint green_programID =
      LoadShaders("SimpleTransform.glsl", "GreenFragmentShader.glsl");

  // Get a handle for our "MVP" uniform
  GLuint MatrixID_red = glGetUniformLocation(blue_programID, "MVP");
  GLuint MatrixID_green = glGetUniformLocation(green_programID, "MVP");
  ...
  do {
    ...
    glm::mat4 View = glm::lookAt(
        glm::vec3(2*cos(alpha), 2, 2*sin(alpha)),  // Camera starts at (2,2,0), in World Space
